...
export const OkColorSlider = ({
  ...
  return (
    <div className={'relative mx-2 flex h-8 w-64 items-center'}>
      <div
        className="border-control-border absolute top-1/2 -left-2 h-8 w-8 -translate-y-1/2 rounded-l-full border"
        aria-hidden="true"
        style={{ backgroundColor: startColor.css }}
      />
      <div
        className="border-control-border absolute top-1/2 -right-2 h-8 w-8 -translate-y-1/2 rounded-r-full border"
        aria-hidden="true"
      ...
      >
        <div
          className="border-control-border h-full w-full border-y"
